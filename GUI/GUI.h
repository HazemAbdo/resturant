...
public:
	...
	// Output Functions  ---------------------------
	void PrintMessage(string msg,string msg1 = " ", string msg2 = " ", string msg3=" ",
		string msg4=" ", string msg5=" ", string msg6=" ",  Node<Cook*>*LastAssignedHead = NULL,
		string msg7 = " ", string msg8 = " ", string msg9 = " ") const; // prints a message in the status bar
